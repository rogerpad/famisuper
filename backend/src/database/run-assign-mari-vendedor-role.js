...
async function assignMariVendedorRole() {
  ...
  try {
    ...
    const sqlPath = path.join(__dirname, 'assign-mari-vendedor-role.sql');
    const sqlContent = fs.readFileSync(sqlPath, 'utf8');

    console.log('Ejecutando script para asignar rol de Vendedor a Mari...');
